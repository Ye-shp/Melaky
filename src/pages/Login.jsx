    ...
    <div className="min-h-screen bg-gray-950 text-white flex items-center justify-center p-6">
      ...
      >
        <div className="glass-strong rounded-3xl p-8 shadow-2xl">
          ...
          >
            <h1 className="text-4xl font-bold mb-2 text-gradient-blue">Welcome back</h1>
          ...
          >
            <div className="relative mb-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-gray-950/50 text-gray-400">Or continue with</span>
              </div>
            </div>
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              className="w-full py-3.5 glass-strong rounded-xl font-semibold hover:bg-white/15 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
            >
          ...
          >
            ...
            <Link to="/register" state={location.state} className="text-blue-400 hover:text-blue-300 font-semibold">
              Create account
            </Link>
          </motion.div>
        </div>
